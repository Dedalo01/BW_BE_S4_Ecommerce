                        ...
                        <div class="col">
                            <div class="card h-100">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="d-flex">
                                        <a href='<%# "Details.aspx?product=" + Eval("Id") %>' class="btn btn-primary mt-auto w-50">Dettagli</a>
                                        <asp:Button ID="DeleteButtonClick" runat="server" CommandName="Delete" CommandArgument='<%# Eval("Id") %>' Text="Cancella" CssClass="btn btn-danger w-50 ms-1" OnClientClick="return confirm('Sei sicuro di voler eliminare questo prodotto?')" />
                                    </div>
